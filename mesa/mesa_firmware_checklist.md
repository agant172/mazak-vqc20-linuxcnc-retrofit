...
| P1 (7i49) | Excitation frequency | 5 kHz (7i49 selectable: 2.5/5/10 kHz; TS2014N141E26 datasheet is 4.5 kHz — 5 kHz is closest available, ~11% above nominal; **Tamagawa page publishes no frequency tolerance**, verify on scope at commissioning) | 5 kHz is a working baseline to verify, not a tolerance claim. |
| P1 (7i49) | Transformation ratio / signal level | K=0.5 (TS2014N141E26 datasheet, no tolerance published); 7i49 default drive ~2 V RMS → SIN/COS ~1 V RMS on a 2:1 resolver | Scope RESDRV excitation and RESSIN/RESCOS amplitude and phase at rest and under motion; **W2 does NOT affect axis channels 0/1/2** (only 3/4/5). |

...
| `15_Mesa_Cards_Firmware` | Mesa board labels, firmware/bitfile notes, 7i80HDT Ethernet/IP settings, 7i44 P1 smart-serial daughter card, 7i49 P2 resolver/analog daughter card, unused P3 header, and both 7i84U smart-serial connection photos. |

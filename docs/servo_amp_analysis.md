...
> **ROLE: REFERENCE** — OEM drive/motor/resolver hardware analysis. Not needed at the cabinet; kept at this path because the pin authority and io-dashboard cite it. See [../INSTALL_SPINE.md](../INSTALL_SPINE.md).

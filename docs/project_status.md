...
- [ ] **(2026-09-06) Decide the fate of `docs/manual_set/*.pdf`.** Built 2026-08-07 from 132 rows, before the 2026-08-23 builder fixes for retracted P1/P2/P3 claims; never rebuilt; CI builds to a temp dir and never compares. Recommendation: `.gitignore` the folder and keep the builder + CI smoke step. Also fix `build_manual_set.py:995-1000` (nonexistent record paths) on the next rebuild. Closure: no stale PDF in the tree.

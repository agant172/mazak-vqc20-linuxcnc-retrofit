...
| ~~132-row I/O authority workbooks regenerated from the current CSV~~ — the three Excel snapshots were never regenerated for the 124-row authority; archived to `archive/workbooks/` 2026-09-06 | 📦 Archived |
...
- [docs/parameters_sn060231.md](docs/parameters_sn060231.md) — LIVE parameter values photographed 2025-08-28: ATC 2nd zero point RP=(0, +9.5000, -5.9055) in, both soft-limit boxes, gear crossover 434 rpm, backlash.

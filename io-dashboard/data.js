...
window.MAZAK_DATA = {
 "meta": {
  ...
  "generated": "2026-08-08 22:10 UTC",
 ...
 "signals": [
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Confirm VFD terminal and polarity | [RECON 2026-08-08: spindle-drive sheet Dwg 4143075403 shows only zero-speed/controller-normal/orient-arrival; NO discrete at-speed output. Derive at-speed in HAL (commanded-vs-actual threshold). Do NOT wire.]",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "element_list_crosswalk_2026-07-27",
   "cleanup_notes": "SOL-31 confirmed via TB-51 diagram. Separate from OUT11 pump on 7i84U-A. | [RECON 2026-08-08 §C: Y011 FCL valve genuinely distinct from Y010 FCM motor; Y012 THC through-hole separate]",
   "location": "Unknown — trace in cabinet",
   "location_note": "",
   "expected": {
    "value": "0",

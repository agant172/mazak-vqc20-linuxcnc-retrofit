...
window.MAZAK_DATA = {
 "meta": {
  ...
  "generated": "2026-08-09 20:02 UTC",
 ...
 "signals": [
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "mesa_firmware_checklist.md",
   "cleanup_notes": "7i44 channel 0 to 7i84U-A CN0 under HostMot2 port 0; RS-422 differential pair | [MESA-CONFIRMED 2026-08-08: matches 7i84U J1 RJ-45 pinout (7i84uman.pdf: p1 RXA/p2 RXB/p3 TXA/p6 TXB/p4-5 GND/p7-8 +5V, 568B colors); straight CAT5 to 7i44; plug-in cable, no continuity trace needed] | [READY 2026-08-09: factory-terminated plug-in cable (50-pin IDC ribbon / CAT5), point-to-point 7i44<->7i84U; nothing to trace, ground, or land. Verified by sserial enumeration at LinuxCNC startup]",
   "location": "Control cabinet — 7i44 channel 0 (7i80HDT P1) to 7i84U-A CN0/RJ45, plug-in RS-422 smart-serial cable",
   "location_note": "Factory-terminated plug-in cable (50-pin IDC ribbon / CAT5) — point-to-point; nothing to trace, ground, or land. Shield drain at the 7i44 end only.",
   "expected": {
    "value": "n/a",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "mesa_firmware_checklist.md",
   "cleanup_notes": "RS-422 differential pair | [MESA-CONFIRMED 2026-08-08: matches 7i84U J1 RJ-45 pinout (7i84uman.pdf: p1 RXA/p2 RXB/p3 TXA/p6 TXB/p4-5 GND/p7-8 +5V, 568B colors); straight CAT5 to 7i44; plug-in cable, no continuity trace needed] | [READY 2026-08-09: factory-terminated plug-in cable (50-pin IDC ribbon / CAT5), point-to-point 7i44<->7i84U; nothing to trace, ground, or land. Verified by sserial enumeration at LinuxCNC startup]",
   "location": "Control cabinet — 7i44 channel 0 (7i80HDT P1) to 7i84U-A CN0/RJ45, plug-in RS-422 smart-serial cable",
   "location_note": "Factory-terminated plug-in cable (50-pin IDC ribbon / CAT5) — point-to-point; nothing to trace, ground, or land. Shield drain at the 7i44 end only.",
   "expected": {
    "value": "n/a",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "mesa_firmware_checklist.md",
   "cleanup_notes": "Shield drain to 7i44 end only | [MESA-CONFIRMED 2026-08-08: matches 7i84U J1 RJ-45 pinout (7i84uman.pdf: p1 RXA/p2 RXB/p3 TXA/p6 TXB/p4-5 GND/p7-8 +5V, 568B colors); straight CAT5 to 7i44; plug-in cable, no continuity trace needed] | [READY 2026-08-09: factory-terminated plug-in cable (50-pin IDC ribbon / CAT5), point-to-point 7i44<->7i84U; nothing to trace, ground, or land. Verified by sserial enumeration at LinuxCNC startup]",
   "location": "Control cabinet — 7i44 channel 0 (7i80HDT P1) to 7i84U-A CN0/RJ45, plug-in RS-422 smart-serial cable",
   "location_note": "Factory-terminated plug-in cable (50-pin IDC ribbon / CAT5) — point-to-point; nothing to trace, ground, or land. Shield drain at the 7i44 end only.",
   "expected": {
    "value": "n/a",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "mesa_firmware_checklist.md",
   "cleanup_notes": "Serial power for 7i84U-A logic | [MESA-CONFIRMED 2026-08-08: matches 7i84U J1 RJ-45 pinout (7i84uman.pdf: p1 RXA/p2 RXB/p3 TXA/p6 TXB/p4-5 GND/p7-8 +5V, 568B colors); straight CAT5 to 7i44; plug-in cable, no continuity trace needed] | [READY 2026-08-09: factory-terminated plug-in cable (50-pin IDC ribbon / CAT5), point-to-point 7i44<->7i84U; nothing to trace, ground, or land. Verified by sserial enumeration at LinuxCNC startup]",
   "location": "Control cabinet — 7i44 channel 0 (7i80HDT P1) to 7i84U-A CN0/RJ45, plug-in RS-422 smart-serial cable",
   "location_note": "Factory-terminated plug-in cable (50-pin IDC ribbon / CAT5) — point-to-point; nothing to trace, ground, or land. Shield drain at the 7i44 end only.",
   "expected": {
    "value": "n/a",
  ...
  },
  {
   ...
   "cleanup_notes": "Update field_7i84u.hal because it currently uses input-02 | [RECON 2026-08-08 §F: PRS-55 (+Y 2nd, +LY2) confirmed by Dwg 4143075409 (Motion Switch Input 3)]",
  ...
  },
  {
   ...
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Update field_7i84u.hal because it currently uses input-03 | [RECON 2026-08-08 §F: PRS-66 (-Z 2nd, -LZ2) confirmed by Dwg 4143075409 (Motion Switch Input 3)]",
  ...
  },
  {
   ...
   "cleanup_notes": "Add HAL net when confirmed | [RECON 2026-08-08 §F: PHS-181 line 381 (settles PHS-127 vs 181) confirmed by Dwg 4143075409 (Motion Switch Input 3)]",
  ...
  },
  {
   ...
   "cleanup_notes": "ATC cannot cycle without orient; confirm FR-SX terminal and polarity | [RECON 2026-08-08 §A: element list confirms X003 ORA1 'ORIENT ARRIVAL' (ladder 3006/4810/5509) on 060231] | [RECON 2026-08-08 §D: FR-SX OBA1(t22)/OBA2(t23) -> CN4-16/CN4-17 (digits verify)]",
   "location": "Unknown — trace in cabinet",
   "location_note": "",
   "expected": {
    "value": "Unknown",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Confirm VFD terminal and polarity | [RECON 2026-08-08: spindle-drive sheet Dwg 4143075403 shows only zero-speed/controller-normal/orient-arrival; NO discrete at-speed output. Derive at-speed in HAL (commanded-vs-actual threshold). Do NOT wire.] | [RECON 2026-08-08 follow-up: status COMMISSIONING_PENDING -> DEFERRED; no field wire, derived in HAL]",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Confirm VFD terminal and polarity | [RECON 2026-08-08 §D: FR-SX FA(t11)/FC(t12) 'controller normal' -> CN4-3/CN4-4 (digits verify)]",
  ...
  },
  {
   ...
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Update field_7i84u.hal because it currently uses input-00 | [RECON 2026-08-08 §F: PRS-9 line 209 TCPRS confirmed by Dwg 4143075409 (Motion Switch Input 3)]",
  ...
  },
  {
   ...
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Update field_7i84u.hal because it currently uses input-01 | [RECON 2026-08-08 §F: PRS-8 line 208 TUCPRS confirmed by Dwg 4143075409 (Motion Switch Input 3)]",
  ...
  },
  {
   ...
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Add HAL net when confirmed | [RECON 2026-08-08 §F: PRS-10 line 210 HGPRS = HIGH gear confirmed by Dwg 4143075409 (Motion Switch Input 3)]",
  ...
  },
  {
   ...
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Add HAL net when confirmed | [RECON 2026-08-08 §F: PRS-12 line 212 LGPRS = LOW gear confirmed by Dwg 4143075409 (Motion Switch Input 3)]",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Digital FWD signal to FR-SX | [RECON 2026-08-08 §D: FR-SX SRN]",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "archived_wiring_map",
   "cleanup_notes": "Digital REV signal to FR-SX | [RECON 2026-08-08 §D: FR-SX SRI]",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "element_list_crosswalk_2026-07-27",
   "cleanup_notes": "Required before clamp/gear/ATC; interposing relay for contactor coil; prove HYD_PRESS_OK after start | [RECON 2026-08-08 §A: element list confirms Y096 HYD.M combined hydraulic + head-lube pump on 060231]",
   "location": "Unknown — trace in cabinet",
   "location_note": "",
   "expected": {
    "value": "0",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "mesa_firmware_checklist.md",
   "cleanup_notes": "7i44 channel 1 to 7i84U-B CN0 under HostMot2 port 0; RS-422 differential pair | [MESA-CONFIRMED 2026-08-08: matches 7i84U J1 RJ-45 pinout (7i84uman.pdf: p1 RXA/p2 RXB/p3 TXA/p6 TXB/p4-5 GND/p7-8 +5V, 568B colors); straight CAT5 to 7i44; plug-in cable, no continuity trace needed] | [READY 2026-08-09: factory-terminated plug-in cable (50-pin IDC ribbon / CAT5), point-to-point 7i44<->7i84U; nothing to trace, ground, or land. Verified by sserial enumeration at LinuxCNC startup]",
   "location": "Control cabinet — 7i44 channel 1 (7i80HDT P1) to 7i84U-B CN0/RJ45, plug-in RS-422 smart-serial cable",
   "location_note": "Factory-terminated plug-in cable (50-pin IDC ribbon / CAT5) — point-to-point; nothing to trace, ground, or land. Shield drain at the 7i44 end only.",
   "expected": {
    "value": "n/a",
    "label": "RS-422 smart-serial link — not a logic state",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "mesa_firmware_checklist.md",
   "cleanup_notes": "Serial power for 7i84U-B logic | [MESA-CONFIRMED 2026-08-08: matches 7i84U J1 RJ-45 pinout (7i84uman.pdf: p1 RXA/p2 RXB/p3 TXA/p6 TXB/p4-5 GND/p7-8 +5V, 568B colors); straight CAT5 to 7i44; plug-in cable, no continuity trace needed] | [READY 2026-08-09: factory-terminated plug-in cable (50-pin IDC ribbon / CAT5), point-to-point 7i44<->7i84U; nothing to trace, ground, or land. Verified by sserial enumeration at LinuxCNC startup]",
   "location": "Control cabinet — 7i44 channel 1 (7i80HDT P1) to 7i84U-B CN0/RJ45, plug-in RS-422 smart-serial cable",
   "location_note": "Factory-terminated plug-in cable (50-pin IDC ribbon / CAT5) — point-to-point; nothing to trace, ground, or land. Shield drain at the 7i44 end only.",
   "expected": {
    "value": "n/a",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "element_list_crosswalk_2026-07-27",
   "cleanup_notes": "Verify device exists on SN 060231 | [RECON 2026-08-08 §A: element list confirms Y095 TCME.M 'BARRIER EXPAND at ATC AREA' on 060231]",
   "location": "Unknown — trace in cabinet",
   "location_note": "",
   "expected": {
    "value": "0",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "element_list_crosswalk_2026-07-27",
   "cleanup_notes": "SOL-31 confirmed via TB-51 diagram. Separate from OUT11 pump on 7i84U-A. | [RECON 2026-08-08 §C: Y011 FCL valve genuinely distinct from Y010 FCM motor; Y012 THC through-hole separate] | [RECON 2026-08-08 follow-up: status PROPOSED -> COMMISSIONING_PENDING per §C element-list confirm]",
   "location": "Unknown — trace in cabinet",
   "location_note": "",
   "expected": {
    "value": "0",

...
window.MAZAK_DATA = {
 "meta": {
  ...
  "generated": "2026-09-06 05:49 UTC",
 ...
 "signals": [
  {
   ...
   "name": "X Resolver",
   "board": "7i49",
   "connector": "P4 Servo Amp/Resolver TB",
   "channel": "RES0",
   "hal_net": "x-pos-fb",
  ...
  },
  {
   ...
   "name": "Z Resolver",
   "board": "7i49",
   "connector": "P3 Servo Amp/Resolver TB",
   "channel": "RES2",
   "hal_net": "z-pos-fb",
   "direction": "RESOLVER_IN",
   "direction_label": "Input (resolver)",
  ...
  },
  {
   ...
   "cleanup_notes": "Available for future resolver feedback if firmware provisions it [Mesa 7i49man.pdf p.5-7 + board photo p.3; confirmed 2026-09-05]",
  ...
  },
  {
   ...
   "name": "Res4 Spare",
   "board": "7i49",
   "connector": "P2 Servo Amp/Resolver TB",
   "channel": "RES4",
   "hal_net": "",
   "direction": "RESOLVER_IN",
   "direction_label": "Input (resolver)",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "motion_7i80hdt.hal",
   "cleanup_notes": "7i49 P4-20 AOUT0 with P4-19 GND0; Plane B OEM connector and DK-427 input polarity are not yet traced. Do not land until the removed NC command pair is continuity-proven. See wiring/plane_b_pin_crosswalk.csv. [Mesa 7i49man.pdf p.5-7 + board photo p.3; confirmed 2026-09-05]",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "motion_7i80hdt.hal",
   "cleanup_notes": "7i49 P4-24 AOUT1 with P4-23 GND1; Plane B OEM connector and DK-427 input polarity are not yet traced. Do not land until the removed NC command pair is continuity-proven. See wiring/plane_b_pin_crosswalk.csv. [Mesa 7i49man.pdf p.5-7 + board photo p.3; confirmed 2026-09-05]",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "motion_7i80hdt.hal",
   "cleanup_notes": "7i49 P3-20 AOUT2 with P3-19 GND2; Plane B OEM connector and DK-427 input polarity are not yet traced. Do not land until the removed NC command pair is continuity-proven. See wiring/plane_b_pin_crosswalk.csv. [Mesa 7i49man.pdf p.5-7 + board photo p.3; confirmed 2026-09-05]",
  ...
  },
  {
   ...
   "cleanup_notes": "FR-SX orient is a discrete ORCM1 command; num_pwmgens=4 creates only pwmgen.00-.03 so AOUT4 is not provisioned in active firmware config [Mesa 7i49man.pdf p.5-7 + board photo p.3; confirmed 2026-09-05]",
   "location": "Unknown — trace in cabinet",
   "location_note": "",
   "expected": {
    "value": "0",
  ...
  },
  {
   ...
   "designations": [],
   "primary_source": "mesa_firmware_checklist.md",
   "cleanup_notes": "Available for future analog use [Mesa 7i49man.pdf p.5-7 + board photo p.3; confirmed 2026-09-05]",
   "location": "Unknown — trace in cabinet",
   "location_note": "",
   "expected": {
    "value": "0",
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     ...
     "wire": "381",
     "old_location": "CN2-13",
     "signal": "TOOL DETECTOR (PHS-181; p85 CN6-37 reads 391 - jacket read decides)",
     "mesa_card": "7i84U-A",
     "connector": "TB3",
     "logical_channel": "IN2",
     "physical_pin": "TB3-03",
   ...
   "sources": [
    ...
    },
    {
     ...
     "lines": "21",
     "note": "Epson Mesa-end ferrule A-TB3-03; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "22",
     "note": "Epson Mesa-end ferrule A-TB3-04; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     ...
     "wire": "219",
     "old_location": "CN2-12",
     "signal": "MAGAZINE COVER CLOSE (RS-19 MGCCRS X53)",
     "mesa_card": "7i84U-A",
     "connector": "TB3",
     "logical_channel": "IN7",
     "physical_pin": "TB3-08",
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "24",
     "note": "Epson Mesa-end ferrule A-TB3-08; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "25",
     "note": "Epson Mesa-end ferrule A-TB3-09; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     ...
     "wire": "341",
     "old_location": "CN2-38",
     "signal": "MACHINE DOOR INTERLOCK",
     "mesa_card": "7i84U-A",
     "connector": "TB2",
     "logical_channel": "IN24",
     "physical_pin": "TB2-09",
     "crosswalk_status": "PLANNED_MATCH",
     "release_status": "HOLD_SOURCE_TRACE",
     "source_line": 31
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "31",
     "note": "Epson Mesa-end ferrule A-TB2-09; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     ...
     "wire": "149B",
     "old_location": "CN2-44",
     "signal": "TOOL CLAMP FOOT SWITCH",
     "mesa_card": "7i84U-A",
     "connector": "TB2",
     "logical_channel": "IN30",
     "physical_pin": "TB2-15",
     "crosswalk_status": "PLANNED_MATCH",
     "release_status": "HOLD_SOURCE_TRACE",
     "source_line": 40
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "40",
     "note": "Epson Mesa-end ferrule A-TB2-15; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     "label_text": "A-TB3-20",
     "wire": "835",
     "old_location": "CN11-16",
     "signal": "HYDR. PUMP HEAD LUBE PUMP",
     "mesa_card": "7i84U-A",
     "connector": "TB3",
     "logical_channel": "OUT3",
     "physical_pin": "TB3-20",
     "crosswalk_status": "PLANNED_MATCH",
     "release_status": "HOLD_SOURCE_TRACE",
     "source_line": 33
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "33",
     "note": "Epson Mesa-end ferrule A-TB3-20; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     ...
     "wire": "712",
     "old_location": "CN11-4",
     "signal": "GEAR SHIFT HIGH",
     "mesa_card": "7i84U-A",
     "connector": "TB3",
     "logical_channel": "OUT7",
     "physical_pin": "TB3-24",
     "crosswalk_status": "PLANNED_MATCH",
     "release_status": "HOLD_SOURCE_TRACE",
     "source_line": 34
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "34",
     "note": "Epson Mesa-end ferrule A-TB3-24; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     ...
     "wire": "713",
     "old_location": "CN11-5",
     "signal": "GEAR SHIFT LOW",
     "mesa_card": "7i84U-A",
     "connector": "TB2",
     "logical_channel": "OUT8",
     "physical_pin": "TB2-17",
     "crosswalk_status": "PLANNED_MATCH",
     "release_status": "HOLD_SOURCE_TRACE",
     "source_line": 35
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "35",
     "note": "Epson Mesa-end ferrule A-TB2-17; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "36",
     "note": "Epson Mesa-end ferrule A-TB2-19; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     "label_text": "A-TB2-20",
     "wire": "736",
     "old_location": "CN11-15",
     "signal": "FLOOD COOLANT MOTOR STARTER (p85 reads 736; p140/p78 read 836 - jacket read decides)",
     "mesa_card": "7i84U-A",
     "connector": "TB2",
     "logical_channel": "OUT11",
     "physical_pin": "TB2-20",
     "crosswalk_status": "PLANNED_MATCH",
     "release_status": "HOLD_SOURCE_TRACE",
     "source_line": 37
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "37",
     "note": "Epson Mesa-end ferrule A-TB2-20; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "38",
     "note": "Epson Mesa-end ferrule B-TB3-20; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "41",
     "note": "Epson Mesa-end ferrule B-TB3-21; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": null,
  ...
  },
  {
   ...
   "epson_ferrules": [
    {
     "label_text": "B-TB3-24",
     "wire": "731",
     "old_location": "CN11-13",
     "signal": "FLOOD COOLANT",
     "mesa_card": "7i84U-B",
     "connector": "TB3",
     "logical_channel": "OUT7",
     "physical_pin": "TB3-24",
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "39",
     "note": "Epson Mesa-end ferrule B-TB3-24; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": {
  ...
  },
  {
   ...
   "sources": [
    ...
    },
    {
     "file": "wiring/labels/bbia1_mesa_end_ferrules_epson.csv",
     "lines": "42",
     "note": "Epson Mesa-end ferrule B-TB2-18; HOLD_SOURCE_TRACE"
    }
   ],
   "conflicts": [],
   "bb_source": null,

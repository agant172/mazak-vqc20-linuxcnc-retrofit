...
def build() -> str:
    ...
    parts = [
        ...
        "<style>",
        "body{font:9pt/1.25 'Helvetica Neue',Arial,sans-serif;margin:0.4in;color:#111}",
        "h1{font-size:13pt;margin:0 0 2pt}",
        ".sub{font-size:8pt;color:#444;margin:0 0 8pt}",
        ".warn{font-size:8pt;border:1.5pt solid #b00;padding:4pt 6pt;margin:0 0 8pt;font-weight:600}",
        "h2{font-size:10pt;margin:8pt 0 3pt;border-bottom:1pt solid #111;page-break-after:avoid}",
        "table{border-collapse:collapse;width:100%;page-break-inside:auto}",
        "tr{page-break-inside:avoid}",
        "th{text-align:left;font-size:7.5pt;text-transform:uppercase;letter-spacing:0.04em;",
        "   border-bottom:1pt solid #555;padding:1pt 6pt 1pt 0}",
        "td{border-bottom:0.5pt solid #ccc;padding:1.5pt 6pt 1.5pt 0;vertical-align:top}",
        ...
        "td.hold{color:#777;font-size:7.5pt}",

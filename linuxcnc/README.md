...
- Mesa **7i44 on P1** — 8-channel RS-422 smart-serial breakout. Physical channels 0/1 carry **7i84U-A/B** within HostMot2 port 0; channels 2-7 are spare.
...
- Mesa 7i44 on P1 for smart-serial fanout to 7i84U-A/B (physical channels 0/1 of HostMot2 port 0).

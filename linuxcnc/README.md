...
2. Confirm the 24 VDC P24/G24 bus and its retrofit 24 V supply, fusing, and 0 V common/reference strategy.
...
- The OEM 24V bus (Shindengen HR-11F-24) and retrofit 24V bus remain isolated. Every OEM-to-retrofit digital crossing (including the OEM E-stop chain monitor) uses an interposing relay dry contact.

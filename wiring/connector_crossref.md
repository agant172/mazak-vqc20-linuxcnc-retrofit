...
| -27 | CTL | CONFIRMED | **Corrected — overturns this pass's own dedicated stroke-template re-verification, which had concluded -17.** `mesa/current_pin_authority.csv`'s `SPINDLE_ORIENT_LOGEAR` row cites a dated, page-cited field trace — "LOCATED 2026-08-08: CTL 'LOW GEAR ORIENT' CON1-27 wire 4-13 T.U CN3-15, Dwg 4143075408 pg134" — which is trusted over the fresh OCR/stroke analysis. Traces to T.U. CN3-15 → (internally) CN4-13. This also resolves ESP1/ESP2 below: with -27 taken, they are -17/-18. |

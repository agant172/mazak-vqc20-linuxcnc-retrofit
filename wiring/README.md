...
- Consolidated wiring master: [`Mazak_Wiring_Master_7i80HDT_7i44_7i49_7i84U_Current_Authority.xlsx`](Mazak_Wiring_Master_7i80HDT_7i44_7i49_7i84U_Current_Authority.xlsx)
  ...
  P2 is unused/spare (confirmed 2026-08-13 by `readhmid`); the Renishaw
  MP-3 probe allocation on 7i84U-B input-15 (opto-isolated 24 V) is
  RESERVED/out of scope (owner decision 2026-08-21; hal_net none, IN15 held spare). The
...
- Visio wiring workbook: [`MESAC_Wiring_Crosswalk.xlsx`](MESAC_Wiring_Crosswalk.xlsx)
  — generated by `python3 scripts/create_wiring_workbook.py`; regenerate after any
  crosswalk CSV change. [`MESAC_Wiring_Crosswalk_VisioImport.csv`](MESAC_Wiring_Crosswalk_VisioImport.csv)
  is a hand-filtered 86-row export of its Visio Import sheet (no generator — keep it
  in sync manually). Note: its `To` column omits the Mesa card, so identical TB/pin
  labels on 7i84U-A and 7i84U-B collide in a Visio import keyed on endpoints.
